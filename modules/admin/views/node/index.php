...
$this->title = 'Сео-тексты';
?>
<h1><?php echo $this->title; ?></h1>
<div class="row-fluid">
    <a href="<?php echo Url::toRoute('node/edit'); ?>" class="btn btn-success">Добавить</a>
</div>
    ...
    <table id="sort-table" class="table table-striped table-hover">
        ...
        <?php foreach ($news as $new) { ?>
            <tr>
                ...
                <td>
                    <?php if ($new->preview) { ?>
                    <img class="img-thumbnail" src="<?php echo Yii::$app->params['params']['pathToImage'] . 'blog/node/' . 'mini_' . $new->preview; ?>">
                    <?php } else { ?>
                        Нет
                    <?php } ?>
                </td>
                ...
                <td>
                    <div class="btn-group-vertical">
                        <a href="<?php echo Url::toRoute(['node/edit', 'id' => $new->id]); ?>" class="btn btn-default btn-xs">Редактировать</a>
...
<script type="text/javascript">
    $(document).ready(function() {
        $('.btn-activate').click(function () {
            var $this = $(this);
            activeAjax($this, '<?php echo Url::toRoute('node/active'); ?>');
        });
        ...
        $('.btn-delete').click(function () {
            ...
            if (agree) {
                var $this = $(this);
                deleteAjax($this, '<?php echo Url::toRoute('node/delete'); ?>');
            }
        });
    });
</script>
